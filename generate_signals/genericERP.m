function erp_signal = genericERP(sample_rate, signal_duration, baseline_duration)
    ...
    p2_amplitude = 1.8;
    n1_amplitude = -5; % Adjusted N1 amplitude
    p3_amplitude = 4; % Adjusted P3 amplitude
    ...
    n1 = n1_amplitude * exp(-(time - 0.17).^2 / (2 * 0.02^2)); % Adjusted N1 component
    p3 = p3_amplitude * exp(-(time - 0.5).^2 / (2 * 0.2^2)); % Adjusted P3 component
